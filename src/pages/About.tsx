        ...
        <section className="section-padding bg-card">
          <div className="container">
            <div className="text-center max-w-2xl mx-auto mb-8 reveal">
              <h2 className="text-3xl md:text-4xl font-bold mb-3 font-serif text-primary">What Drives Us</h2>
            ...
            <div className="space-y-8">
              ...
              <div className="bg-card border border-border rounded-2xl overflow-hidden">
                ...
                <div className="p-6 md:p-10 space-y-8">
                  ...
                  <div className="grid md:grid-cols-2 gap-8">
                    <div>
                      <h4 className="text-xl font-bold font-serif mb-4">Board & Regulatory Advisory</h4>
                      <ul className="space-y-2">
                        {[
                    ...
                    <div>
                      <h4 className="text-xl font-bold font-serif mb-4">Leadership & Institutional Experience</h4>
                      <ul className="space-y-2">
                        {[
          ...
          <div className="container">
            <div className="reveal relative max-w-2xl mx-auto text-center">
              ...
              <div className="relative bg-card border border-border rounded-xl p-10">
                <h2 className="text-2xl md:text-3xl font-bold mb-3 font-serif text-primary">Our Purpose</h2>
                <div className="line-gold mx-auto mt-4 mb-5" />
                <p className="text-muted-foreground leading-snug mb-6">
