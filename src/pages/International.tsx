        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start mb-20">
          ...
          <div className="bg-card border border-border rounded-lg p-8">
            ...
            <ul className="space-y-4">
              {["Top 5 in Africa for ease of doing business", "Political stability and strong governance", "Strategic access to East and Central African markets", "Growing tech and financial services hub", "Investor protection and incentive frameworks"].map((item) => (
