    ...
    <section className="relative min-h-screen flex items-start justify-center overflow-hidden">
      ...
      <div className="container relative z-10 pt-20 md:pt-24 py-20">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold font-heading text-foreground drop-shadow-[0_2px_4px_rgba(0,0,0,0.5)] mb-6">International Clients</h1>
    ...
    <section className="section-padding">
      <div className="container">
        <div className="grid lg:grid-cols-2 gap-16 items-start mb-20">
          <div>
            <h2 className="text-3xl font-bold mb-6 font-heading">Rwanda as an Investment Destination</h2>
          ...
          <div className="bg-card border border-border rounded-lg p-8">
            <h3 className="text-xl font-bold mb-6 font-heading text-primary">Why Rwanda?</h3>
        ...
        <div className="mb-16">
          ...
          <h2 className="text-3xl font-bold mb-12 font-heading">How We Support International Clients</h2>
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {services.map((s) => (
              <div key={s.title} className="bg-card border border-border rounded-lg p-8 hover:border-primary/30 transition-colors">
                ...
                <h3 className="text-lg font-semibold mb-3 font-heading">{s.title}</h3>
